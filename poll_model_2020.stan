data{
  ...
  int<lower = 1, upper = T> day_national[N_national_polls];   // Day index, national
  int<lower = 1, upper = T> day_state[N_state_polls];   // Day index, state
  int<lower = 1, upper = P> poll_national[N_national_polls];  // Pollster index, national
  int<lower = 1, upper = P> poll_state[N_state_polls];  // Pollster index, state
  int<lower = 1, upper = M> poll_mode_national[N_national_polls];  // Poll mode index, national
  int<lower = 1, upper = M> poll_mode_state[N_state_polls];  // Poll mode index, state
  int<lower = 1, upper = Pop> poll_pop_national[N_national_polls];  // Poll mode index, national
  int<lower = 1, upper = Pop> poll_pop_state[N_state_polls];  // Poll mode index, state
